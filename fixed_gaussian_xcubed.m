...
[Xnopt]=nonstrategic_quantization_hloop(xval,N,p,yval);%returns quantization decision levels
Yn=decoder(Xnopt,xval,p,yval);%returns quantization representative levels
%encoder distortion
endistortion=encoderdistortion(Xnopt,Yn,xval,p,yval);
%decoder distortion
dedistortion=decoderdistortion(Xnopt,Yn,xval,p,yval);
...
save('xcubed_str.mat','Nval','Xnopt2','Yn2','endistortion2','dedistortion2','Xnopt4','Yn4','endistortion4','dedistortion4','Xnopt8','Yn8','endistortion8','dedistortion8','Xnopt16','Yn16','endistortion16','dedistortion16','Xnopt32','Yn32','endistortion32','dedistortion32');
...
function [Xnopt]=nonstrategic_quantization_hloop(xval,N,p,yval)
...
for i=1:size(D1val,1)%iterate over possible (alpha,beta) pairs
    ...
    D1(i)=encoderdistortion([D1val(i,1);D1val(i,2)],q,xval,p,yval);%distortion D1
end
